  ...
  defineConfig({
    server: {
      proxy: {
        ...
        // 全局 WebSocket
        '/ws': {
          target: 'ws://191.1.1.5:32201',
          ws: true,
          changeOrigin: true,
        },
        // 设备websocket直连
        '/v3': {
          target: 'ws://191.1.1.5:32041',
          ws: true,
          changeOrigin: true,
        },
        '/storage': {
        ...
        // 历史视频
        '/stream': {
          target: 'http://191.1.1.5:32011',
          changeOrigin: true,
        },
        '/ja-map': {
          target: 'http://191.1.1.5:32712',
          changeOrigin: true,
        },
        // 视频下载
        '/vod/download': {
          target: 'http://191.1.1.5:31118',
          changeOrigin: true,
        },
      },
    },
    define: {
      ...
      __DEV_MERGE_CONFIG__: {
        ...
        loginUrl: 'http://191.1.1.5:32712/login',
        defaultImageries: [
          {
