!(function (e, t) {
  ...
  var c = p(function (z) {
      ...
      var t,
        ...
        j =
          ($
            ? ((e = h ? At.default.dirname(e) + '/' : __dirname + '/'),
              (O = () => {
                N || ((M = Bt.default), (N = At.default));
              }),
              (t = function (e, t) {
                return (
                  O(),
      ...
      function C(e, t, r) {
        ...
        (B[e] = t),
          delete ge[e],
          A.hasOwnProperty(e) &&
            ((r = A[e]), delete A[e], r.forEach((e) => e()));
      }
      function Ae(e) {
            ...
            return (
              ct().forEach(function (e, t) {
                for (
                  ...
                  u[s++ >> 0] = i.charCodeAt(n);
                (u[s >> 0] = 0), (l += e.length + 1);
              }),
              0
            );
          },
  ...
  const pe = 'fetch',
    ...
    Ue = 'streamSuccess',
    K = 'fetchError',
    X = { h264: 'H264(AVC)', h265: 'H265(HEVC)' },
    Z = { AAC: 10, ALAW: 7, MULAW: 8, MP3: 2 },
    J = {
      sps: 7,
      pps: 8,
      iFrame: 5,
    ...
    xe = { h264: 'avc', h265: 'hevc' },
    Ae = 'AbortError',
    g = { sequenceHeader: 0, nalu: 1 },
    y = { keyFrame: 1, interFrame: 2 },
    Be = 'idle',
    ke = 'buffering',
    ee = 'complete';
  function Te(e) {
    return Ce(e) && e[1] === g.sequenceHeader;
  }
  function Ce(e) {
    return e[0] >> 4 === Z.AAC;
  }
  ...
  function Pe(r, i) {
    let s = (r = i ? r.filter((e) => e.type && e.type === i) : r)[0],
      n = null,
      e = 1;
    var t;
    if (
      ...
      for (let t = e; t < r.length; t++) {
        let e = r[t];
        !(e = i && e.type && e.type !== i ? null : e) ||
          (1e3 <= e.ts - s.ts && r[t - 1].ts - s.ts < 1e3 && (n = t + 1));
      }
    return n;
  }
  function ie(e) {
    return e[0] >> 4 === y.keyFrame && e[1] === g.sequenceHeader;
  }
  function se(e) {
    return !0 === e || 'true' === e;
  }
  ...
  (ae.U32 = v), (ae.U16 = w), (ae.U8 = S);
  class Le {
    constructor(n) {
      (this.log = function (e) {
        if (n._opt.debug && n._opt.debugLevel == m) {
          for (
        ...
        (this.warn = function (e) {
          if (
            n._opt.debug &&
            (n._opt.debugLevel == m || n._opt.debugLevel == _)
          ) {
            for (
              var t = n._opt.debugUuid ? `[${n._opt.debugUuid}]` : '',
                r = arguments.length,
  ...
  class I {
    ...
    static parseSPS(e) {
      ...
      var A = 16 * (i + 1),
        B = 16 * (u + 1) * (2 - f),
        i = ((A -= (p + c) * U), (B -= (m + _) * x), Math.ceil(A * E));
      return (
        r.destroy(),
        (r = null),
        {
          ...
          codec_size: { width: A, height: B },
          present_size: { width: i, height: B },
        }
      );
    }
    static parseSPS$2(e) {
      ...
      return (
        ...
        (s = null),
        {
          ...
          frame_rate: { fixed: x, fps: U, fps_den: B, fps_num: A },
  ...
  function Oe(e) {
    return e === J.kSliceSEI;
  }
  function Ge(e) {
    return (t = e) !== J.sps && t !== J.pps && !Oe(e);
    var t;
  }
  function He(e) {
    return e === J.iFrame;
        ...
        if (
          (n.readBool() &&
            (0 < (b = n.readByte()) && b < 16
              ...
              : 255 === b && ((B = n.readBits(16)), (k = n.readBits(16)))),
          n.readBool() && n.readBool(),
          n.readBool() &&
    ...
    if (!(r.length < 4)) {
      ...
      for (; t + i < s; )
        if (
          ((e = (function (e, t) {
            return (
              ((e[(t = 1 < arguments.length && void 0 !== t ? t : 0)] << 24) >>>
                0) +
              (e[t + 1] << 16) +
              (e[t + 2] << 8) +
              (e[t + 3] || 0)
  ...
  function je(e) {
    var { vps: e, pps: t, sps: r } = e,
      ...
      a =
        ...
        (n[27] = (255 & e.byteLength) >> 0),
        n.set(e, 28),
        (n[23 + (5 + e.byteLength) + 0] = 128 | Q.sps),
        (n[23 + (5 + e.byteLength) + 1] = 0),
        (n[23 + (5 + e.byteLength) + 2] = 1),
        (n[23 + (5 + e.byteLength) + 3] = (65280 & r.byteLength) >> 8),
        (n[23 + (5 + e.byteLength) + 4] = (255 & r.byteLength) >> 0),
        n.set(r, 23 + (5 + e.byteLength) + 5),
        (n[23 + (5 + e.byteLength + 5 + r.byteLength) + 0] = 128 | Q.pps),
  ...
  function n(e, t) {
    if (e.buffer && 'Uint8Array' === e.name)
      return (e = t
        ...
        : e);
    if (Array.isArray(e)) {
      if (z(e)) return new Uint8Array(e);
      throw new Error('Array contains invalid value: ' + e);
    }
    if (L(e.length) && z(e)) return new Uint8Array(e);
  ...
  (i.prototype._prepare = function () {
    ...
    for (
      var r, i = 4 * (e + 1), s = this.key.length / 4, n = st(this.key), t = 0;
      t < s;
      t++
    )
    ...
    (i.prototype.encrypt = function (e) {
      ...
      for (
        var t = this._Ke.length - 1, r = [0, 0, 0, 0], i = st(e), s = 0;
        s < 4;
        s++
      )
        i[s] ^= this._Ke[0][s];
    ...
    (i.prototype.decrypt = function (e) {
      ...
      for (
        var t = this._Kd.length - 1, r = [0, 0, 0, 0], i = st(e), s = 0;
        s < 4;
        s++
      )
        i[s] ^= this._Kd[0][s];
      ...
      for (var a, o = l(16), s = 0; s < 4; s++)
        (a = this._Kd[t][s]),
          (o[4 * s] = 255 & (O[(i[s] >> 24) & 255] ^ (a >> 24))),
          (o[4 * s + 1] = 255 & (O[(i[(s + 3) % 4] >> 16) & 255] ^ (a >> 16))),
          (o[4 * s + 2] = 255 & (O[(i[(s + 2) % 4] >> 8) & 255] ^ (a >> 8))),
          (o[4 * s + 3] = 255 & (O[255 & i[(s + 1) % 4]] ^ a));
      return o;
    }),
    (nt.prototype.encrypt = function (e) {
    ...
    (nt.prototype.decrypt = function (e) {
      if ((e = n(e)).length % 16 != 0)
        throw new Error(
    ...
    (at.prototype.encrypt = function (e) {
      if ((e = n(e)).length % 16 != 0)
        throw new Error(
          'invalid plaintext size (must be multiple of 16 bytes)',
        );
    ...
    (at.prototype.decrypt = function (e) {
      if ((e = n(e)).length % 16 != 0)
        throw new Error(
          'invalid ciphertext size (must be multiple of 16 bytes)',
        );
    ...
    (ot.prototype.encrypt = function (e) {
    ...
    (ot.prototype.decrypt = function (e) {
      if (e.length % this.segmentSize != 0)
    ...
    (lt.prototype.decrypt = lt.prototype.encrypt =
      function (e) {
  ...
  dt.prototype.decrypt = dt.prototype.encrypt = function (e) {
    for (var t = n(e, !0), r = 0; r < t.length; r++)
  ...
  const ht = {
    AES: i,
    Counter: r,
    ModeOfOperation: { ecb: nt, cbc: at, cfb: ot, ofb: lt, ctr: dt },
    utils: { hex: h, utf8: d },
    padding: {
      pkcs7: {
        pad: function (e) {
  ...
  var ue = p(function (e, t) {
    ...
    b.initialize(),
      ...
      (t.Textin4Parser = n);
    (A.prototype.setSegmentOptions = function (e, t, r) {
      var i,
      ...
      (A.prototype.unsetExtractionOptions = function (e) {
      ...
      (A.prototype.checkBuffer = function (e) {
      ...
      (A.prototype.appendBuffer = function (e, t) {
        var r;
      ...
      (A.prototype.processSamples = function (e) {
        var t;
      ...
      (A.prototype.getBox = function (e) {
        e = this.getBoxes(e, !0);
        return e.length ? e[0] : null;
      }),
      (A.prototype.getBoxes = function (e, t) {
        var r = [];
        return A._sweep.call(this, e, r, t), r;
      }),
      (A._sweep = function (e, t, r) {
        for (var i in (this.type && this.type == e && t.push(this),
        this.boxes)) {
          if (t.length && r) return;
          A._sweep.call(this.boxes[i], e, t, r);
        }
      }),
      (A.prototype.getTrackSamplesInfo = function (e) {
        e = this.getTrackById(e);
        return e ? e.samples : void 0;
      }),
      (A.prototype.getTrackSample = function (e, t) {
        e = this.getTrackById(e);
        return this.getSample(e, t);
      }),
      (A.prototype.releaseUsedSamples = function (e, t) {
        var r = 0,
      ...
      (A.prototype.seekTrack = function (e, t, r) {
        var i,
          s,
          n,
          a,
      ...
      ((t.ISOFile = A).prototype.lastBoxStartPosition = 0),
      (A.prototype.parsingMdat = null),
      (A.prototype.nextParsePosition = 0),
      (A.prototype.discardMdatData = !1),
      (A.prototype.processIncompleteBox = function (e) {
        var t;
        return 'mdat' === e.type
      ...
      (A.prototype.hasIncompleteMdat = function () {
        return null !== this.parsingMdat;
      }),
      (A.prototype.processIncompleteMdat = function () {
      ...
      (A.prototype.restoreParsePosition = function () {
      ...
      (A.prototype.saveParsePosition = function () {
        this.lastBoxStartPosition = this.stream.getPosition();
      }),
      (A.prototype.updateUsedBytes = function (e, t) {
      ...
      (A.prototype.add = b.Box.prototype.add),
      (A.prototype.addBox = b.Box.prototype.addBox),
      ...
      (A.prototype.addSample = function (e, t, r) {
        var r = r || {},
          i = {},
          e = this.getTrackById(e);
        if (null !== e)
      ...
      (A.prototype.createSingleSampleMoof = function (e) {
      ...
      (A.prototype.lastMoofIndex = 0),
      (A.prototype.samplesDataSize = 0),
      (A.prototype.resetTables = function () {
        var e, t;
        for (
      ...
      (A.initSampleGroups = function (e, t, r, i, s) {
        var n, a, o, l;
        function d(e, t, r) {
          (this.grouping_type = e),
      ...
      (A.setSampleGroupProperties = function (e, t, r, i) {
        var s, n, a;
          ...
          for (t = 0; t < s.sample_sizes.length; t++) {
            ...
            (x.number = t),
              ...
              o
                ? (t == o.sample_numbers[S] - 1
                  ...
                  d &&
                    ...
                    E++))
                : (x.is_sync = !0),
              A.process_sdtp(e.mdia.minf.stbl.sdtp, x, x.number),
              ...
              (0 < h.length || 0 < u.length) &&
                A.setSampleGroupProperties(e, x, t, e.sample_groups_info);
          }
          0 < t &&
      ...
      (A.prototype.updateSampleLists = function () {
      ...
      (A.prototype.getSample = function (e, t) {
        var r = e.samples[t];
      ...
      (A.prototype.releaseSample = function (e, t) {
        e = e.samples[t];
        return e.data
      ...
      (A.prototype.getAllocatedSampleDataSize = function () {
      ...
      (A.prototype.getTrexById = function (e) {
        var t;
      ...
      (A.prototype.items = []),
      (A.prototype.itemsDataSize = 0),
      (A.prototype.flattenItemInfo = function () {
        var e = this.items,
          t = this.meta;
      ...
      (A.prototype.releaseItem = function (e) {
        var t = this.items[e];
        if (t.data) {
      ...
      (A.prototype.processItems = function (e) {
      ...
      (A.prototype.hasItem = function (e) {
        for (var t in this.items) {
          t = this.items[t];
      ...
      (A.prototype.getMetaHandler = function () {
        return this.meta ? this.meta.hdlr.handler : null;
      }),
      (A.prototype.getPrimaryItem = function () {
        return this.meta && this.meta.pitm
          ? this.getItem(this.meta.pitm.item_id)
          : null;
      }),
      (A.prototype.itemToFragmentedTrackFile = function (e) {
        var t,
          r,
          e = e || {};
        return null !=
          (e = e.itemId ? this.getItem(e.itemId) : this.getPrimaryItem()) &&
          (((t = new A()).discardMdatData = !1),
      ...
      (A.prototype.createFragment = function (e, t, r) {
      ...
      (A.writeInitializationSegment = function (e, t, r, i) {
      ...
      (A.prototype.initializeSegmentation = function () {
        var e, t, r, i;
        for (
          null === this.onSegment &&
          ...
          (s.mvhd = this.moov.mvhd),
            ...
            (i.buffer = A.writeInitializationSegment(
              this.ftyp,
              s,
  ...
  ue.Log,
    ue.MP4BoxStream,
    ue.DataStream,
    ue.MultiBufferStream,
    ue.MPEG4DescriptorParser,
    ue.BoxParser,
    ue.XMLSubtitlein4Parser,
    ue.Textin4Parser,
    ue.ISOFile,
    ue.createFile;
  class pt {
      ...
      if ((this.s || !(50 < this.l)) && (this.l++, !this.d)) {
        ...
        if (this.A) {
          ...
          var r = (function (e, t) {
            ...
            if (r) {
              const t = ut(e.slice(r + 16, r + 16 + 8));
              return [
                t,
                ut(e.slice(r + 24, r + 24 + 8)),
  ...
  function yt(e) {
    return e ^ t(e, 2) ^ t(e, 10) ^ t(e, 18) ^ t(e, 24);
  }
  function bt(e) {
    return e ^ t(e, 13) ^ t(e, 23);
  }
  function vt(t, r, i, e) {
    let {
      padding: s = 'pkcs#7',
    ...
    if ('cbc' === n && 16 !== (a = 'string' == typeof a ? gt(a) : a).length)
      throw new Error('iv is invalid');
    if (16 !== (r = 'string' == typeof r ? gt(r) : r).length)
    ...
    for (let e, t = 0; t < 32; t += 4)
      (e = u[1] ^ u[2] ^ u[3] ^ _t[t + 0]),
        (h[t + 0] = u[0] ^= bt(A(e))),
        (e = u[2] ^ u[3] ^ u[0] ^ _t[t + 1]),
        (h[t + 1] = u[1] ^= bt(A(e))),
        (e = u[3] ^ u[0] ^ u[1] ^ _t[t + 2]),
        (h[t + 2] = u[2] ^= bt(A(e))),
        (e = u[0] ^ u[1] ^ u[2] ^ _t[t + 3]),
        (h[t + 3] = u[3] ^= bt(A(e)));
    if (e === U)
  ...
  const o = { init: 0, findFirstStartCode: 1, findSecondStartCode: 2 };
  class wt extends class {
    ...
    dispatch(e, t) {
      ...
      for (
          ...
          for (
            ...
            if (
              ...
              (this.versionLayer = this.tempBuffer[this.parsedOffset + 1]),
                (this.state = o.findFirstStartCode),
        ...
        if (this.state == o.findFirstStartCode) {
          let e = !1;
          for (
            ;
            2 <= this.tempBuffer.length - this.parsedOffset &&
            ...
            if (
              ...
              (this.state = o.findSecondStartCode),
  ...
  function St(l, z) {
    function s() {
      if (((T = !0), I.fetchStatus !== ke || ne(I._opt.isChrome))) {
        if (h)
          try {
            h.abort(), (h = null);
          } catch (e) {
      ...
      } else (h = null), I.debug.log('worker', `abort() and not abortController.abort() _status is ${I.fetchStatus} and _isChrome is ` + I._opt.isChrome);
    }
    let n = 1 < arguments.length && void 0 !== z && z,
      ...
      C =
          ...
          (o = {
            ...
            decoder: new VideoDecoder({
              output: function (t) {
                ...
                o.isEmitInfo ||
                  ...
                  postMessage({ cmd: _e, w: t.codedWidth, h: t.codedHeight }),
                  (o.isEmitInfo = !0),
                  ...
                  'function' == typeof t.createImageBitmap
                    ? t.createImageBitmap().then((e) => {
                        ...
                        postMessage(
                          { cmd: j, buffer: e, delay: I.delay, ts: 0 },
                          [e],
                        ),
                          Ie(t);
                      })
            ...
            decode: function (e, t, r) {
              ...
              if (o.hasInit) {
                ...
                I._opt.recordType === $ &&
                  postMessage({ cmd: be, buffer: e, codecId: t }, [e.buffer]),
          ...
          }),
        {
          ...
          handleVideoNalu(e) {
            ...
            } else if (C.streamType === X.h265)
              if (I._opt.nakedFlowH265DemuxUseNew) {
                (t = C.handleAddNaluStartCode(e)), (t = C.extractNALu(t));
                if (0 === t.length)
                  I.debug.warn(
                    'worker',
                    'handleVideoNalu',
          ...
          extractH264PPS(e) {
            ...
            C.extractNALu(e).forEach((e) => {
              Oe(le(e)) ? C.extractH264SEI(e) : C.handleVideoH264Nalu(e);
            });
          },
          extractH265PPS(e) {
            e = C.handleAddNaluStartCode(e);
            C.extractNALu(e).forEach((e) => {
              he(e) === Q.sei ? C.extractH265SEI(e) : C.handleVideoH265Nalu(e);
            });
          },
          extractH264SEI(e) {
            e = C.handleAddNaluStartCode(e);
          ...
          handleVideoH264Nalu(e) {
            ...
            if (C.isSendSeqHeader) {
              if (C.sps && C.pps) {
                const e = Me({ sps: C.sps, pps: C.pps }),
                  t = C.getNaluDts();
          ...
          handleVideoH265Nalu(e) {
            ...
            if (C.isSendSeqHeader) {
              if (C.vps && C.sps && C.pps) {
                const e = je({ vps: C.vps, sps: C.sps, pps: C.pps }),
                  t = C.getNaluDts();
                I.decode(e, { type: 2, ts: t, isIFrame: !0, cts: 0 }),
                  (C.vps = null),
                  (C.sps = null),
          ...
          doDecode(e, t) {
            I.calcNetworkDelay(t.ts),
              ...
              postMessage({ cmd: W, type: Y, value: e.byteLength }),
              postMessage({ cmd: W, type: q, value: t.ts }),
              I.decode(e, t);
          },
        }),
      F = {
        LOG_NAME: 'worker fmp4Demuxer',
        mp4Box: ue.createFile(),
        offset: 0,
        videoTrackId: null,
        audioTrackId: null,
        isHevc: !1,
        ...
        initTransportDescarmber() {
          F.transportDescarmber = new pt();
        },
        _getSeqHeader(t) {
          const r = F.mp4Box.getTrackById(t.id);
          for (const t of r.mdia.minf.stbl.stsd.entries)
            if (t.avcC || t.hvcC) {
              const r = new ue.DataStream(void 0, 0, ue.DataStream.BIG_ENDIAN);
              let e = [];
              e = t.avcC
        ...
        onReady(i) {
          ...
          if (e && I._opt.hasAudio) {
            F.audioTrackId = e.id;
            const i = e.audio || {},
              s = Fe.indexOf(i.sample_rate),
        ...
        onSamples(e, t, r) {
          if (e === F.videoTrackId)
            for (const e of r) {
              ...
              var i = (F.isHevc ? We : Ne)(t, r);
              postMessage({ cmd: W, type: Y, value: i.byteLength }),
                postMessage({ cmd: W, type: q, value: n }),
            ...
            if (I._opt.hasAudio)
              for (const e of r) {
                ...
                s.set([175, 1], 0),
                  s.set(t, 2),
                  postMessage({ cmd: W, type: Ee, value: s.byteLength }),
            ...
            for (
              ...
              if ('findSecondStartCode' === D.state) {
                if (!(0 < D.lastBuffer.length - D.parsedOffset)) break;
                {
                  ...
                  var s = D.getNaluDts();
                  D.hasInitVideoCodec
                    ? (postMessage({ cmd: W, type: Y, value: t.byteLength }),
                      postMessage({ cmd: W, type: q, value: s }),
                      L.decode(t, i ? 1 : 0, s))
      ...
      I = {
        ...
        startStreamRateAndStatsInterval: function () {
          I.stopStreamRateAndStatsInterval(),
            (e = setInterval(() => {
              ...
              postMessage({ cmd: W, type: 'streamStats', value: e });
            }, 1e3));
        },
        ...
        getDelay: function (e, t) {
          if (!e || (I._opt.hasVideo && !m)) return -1;
          if (1 !== t) {
            if (I.preDelayTimestamp && I.preDelayTimestamp > e)
              1e3 < I.preDelayTimestamp - e &&
                I.debug.warn(
                  ...
                  }ms and return ` + I.delay,
                );
            else if (I.firstTimestamp) {
              if (e) {
                const t = Date.now() - I.startTimestamp,
                  r = e - I.firstTimestamp;
                t >= r
                  ? ((i = !1), (I.delay = t - r))
                  : ((i = !0), (I.delay = r - t));
              }
        ...
        getDelayNotUpdateDelay: function (t, r) {
          if (t && (!I._opt.hasVideo || m)) {
            if (1 === r) return I.pushLatestDelay;
            if (I.preDelayTimestamp && 1e3 < I.preDelayTimestamp - t)
              I.debug.warn(
                'worker',
                `getDelayNotUpdateDelay() and preDelayTimestamp is ${
                  I.preDelayTimestamp
                } > timestamp is ${t} more than ${
                  I.preDelayTimestamp - t
                }ms and return -1`,
              );
            else if (I.firstTimestamp) {
              let e = -1;
        ...
        init: function () {
              ...
              if (a.length)
                if (I.isPushDropping)
                  ...
                  for (
                    ...
                    e = a.shift();
                  const t = I.getDelayNotUpdateDelay(e.ts, e.type);
                  e.isIFrame &&
                    ...
                    I.doDecode(e),
                    I.decodeNext(e));
                } else if (I.isPlayback)
                  for (; a.length; ) (e = a.shift()), I.doDecode(e);
                else if (((e = a[0]), -1 === I.getDelay(e.ts, e.type)))
                  I.debug.log(
                    'worker',
                  ...
                  for (; a.length; ) {
                    if (
                      ((e = a[0]),
                      !(I.getDelay(e.ts, e.type) > I._opt.videoBuffer))
                    ) {
                      I.delay < 0 &&
                        I.debug.warn(
                          'worker',
          ...
          ne(I._opt.checkFirstIFrame) && (m = !0);
        },
        playbackCacheLoop: function () {
          ...
          I.debug.log(
            'worker',
            `playbackCacheLoop fragDuration is ${t}, streamFps is ${I.streamFps}, streamAudioFps is ${I.streamAudioFps} ,streamVideoFps is ${I.streamVideoFps} playbackRate is ` +
              I._opt.playbackRate,
          ),
        ...
        close: function () {
          if (
            ...
            (I.isDestroyed = !0),
            s(),
            !t || (1 !== t.readyState && 2 !== t.readyState)
              ? t &&
                I.debug.log(
                  'worker',
                  'close() and socket.readyState is ' + t.readyState,
                )
              : ((T = !0), t.close(1e3, 'Client disconnecting')),
            (t = null),
            I.stopStreamRateAndStatsInterval(),
            I.stopId && (clearInterval(I.stopId), (I.stopId = null)),
            I.mp3Demuxer && (I.mp3Demuxer.destroy(), (I.mp3Demuxer = null)),
            I.writableStream &&
              ne(I.writableStream.locked) &&
              I.writableStream.close().catch((e) => {
                I.debug.log(
                  'worker',
        ...
        pushBuffer: function (r, i) {
          if (1 === i.type && Te(r)) {
            if (
              ...
              postMessage({ cmd: 'aacSequenceHeader', buffer: i }, [i.buffer]);
            }
            I.decodeAudio(r, i.ts);
          } else if (2 === i.type && i.isIFrame && ie(r)) {
            if (
              (I.debug.log(
                'worker',
              ...
              const i = new Uint8Array(r);
              postMessage({ cmd: 'videoSequenceHeader', buffer: i }, [
                i.buffer,
              ]);
            }
            I.decodeVideo(r, i.ts, i.isIFrame, i.cts);
          } else {
            if (I._opt.isRecording)
              if (I._opt.isRecordTypeFlv) {
                const a = new Uint8Array(r);
                postMessage(
                  { cmd: 'flvBufferData', type: i.type, buffer: a, ts: i.ts },
                  [a.buffer],
                );
              } else if (I._opt.recordType === $)
                if (2 === i.type) {
                  const a = new Uint8Array(r).slice(5);
                  postMessage(
                    {
                      cmd: 'videoNalu',
                      buffer: a,
                ...
                } else if (1 === i.type && I._opt.isWasmMp4) {
                  const a = new Uint8Array(r),
                    e = Ce(a) ? a.slice(2) : a.slice(1);
                  postMessage({ cmd: 'audioNalu', buffer: e, ts: i.ts }, [
                    e.buffer,
                  ]);
                }
            if (I.isPlayer && 0 < x && 0 < U && 2 === i.type) {
              const r = i.ts - U,
                a = x + x / 2;
              r > a &&
                I.debug.warn(
                  'worker',
                  `pushBuffer video
                    ts is ${i.ts}, preTimestamp is ${U},
                    diff is ${r} and preTimestampDuration is ${x} and maxDiff is ${a}
            ...
            if (
              (I.isPlayer &&
                ...
                (I.debug.warn(
                  'worker',
                  `pushBuffer,
                preTimestamp is ${U}, options.ts is ${i.ts},
                diff is ${U - i.ts} more than 3600000,
                and resetAllDelay`,
                ),
                I.resetAllDelay()),
              I.isPlayer &&
                ...
                (I.debug.warn(
                  'worker',
                  `pushBuffer,
                options.ts is ${i.ts} less than (or equal) preTimestamp is ${U} and
                payloadBufferSize is ${r.byteLength} and prevPayloadBufferSize is ` +
                    N,
                ),
                I._opt.isDropSameTimestampGop) &&
                m)
            ) {
              const r = I.hasIframeInBufferList(),
                i = ne(I.isPushDropping);
              I.debug.log(
                'worker',
                `pushBuffer, isDropSameTimestampGop is true and
                    hasIframe is ${r} and isNotPushDropping is ` + i,
              ),
                void (r && i ? I.dropBuffer$2() : I.clearBuffer(!0));
            } else {
              if (I.isPlayer && m) {
                const r = I._opt.videoBuffer + I._opt.videoBufferDelay,
                  a = I.getDelayNotUpdateDelay(i.ts, i.type);
                (I.pushLatestDelay = a) > r &&
                  I.delay < r &&
                  0 < I.delay &&
                  I.hasIframeInBufferList() &&
                  !1 === I.isPushDropping &&
                  (I.debug.log(
                    'worker',
                    `pushBuffer(), pushLatestDelay is ${a} more than ${r} and decoder.delay is ${I.delay} and has iIframe and next decoder.dropBuffer$2()`,
                  ),
                  I.dropBuffer$2());
              }
              if (
                (I.isPlayer &&
                  2 === i.type &&
                  (0 < U && (x = i.ts - U), (N = r.byteLength), (U = i.ts)),
                1 === i.type
                  ? a.push({
                      ts: i.ts,
                      payload: r,
                ...
                I.isPlaybackCacheBeforeDecodeForFpsRender() &&
                  (re(I.streamVideoFps) || re(I.streamAudioFps)))
              ) {
                ...
                re(I.streamVideoFps) &&
                  (e = Pe(a, 2)) &&
                  ((I.streamVideoFps = e),
                  postMessage({ cmd: we, value: I.streamVideoFps }),
                  (I.streamFps = t ? e + t : e),
                  ne(I._opt.hasAudio) &&
                    (I.debug.log(
                      'worker',
                  ...
                  re(I.streamVideoFps) &&
                    re(I.streamAudioFps) &&
                    ((r = a.map((e) => ({ type: e.type, ts: e.ts }))),
                    I.debug.log(
                      'worker',
                      `playbackCacheBeforeDecodeForFpsRender, calc streamAudioFps is ${t}, streamVideoFps is ${e}, bufferListLength  is ${a.length}, and ts list is ` +
                        JSON.stringify(r),
                    ));
                (i = 0 < I.getAudioBufferLength()), (r = i ? 60 : 40);
                a.length >= r &&
                  (I.debug.warn(
                    'worker',
                    `playbackCacheBeforeDecodeForFpsRender, bufferListLength  is ${a.length} more than ${r}, and hasAudio is ${i} an set streamFps is 25`,
                  ),
                  (I.streamVideoFps = 25),
                  postMessage({ cmd: we, value: I.streamVideoFps }),
                  i
                    ? ((I.streamAudioFps = 25),
                      (I.streamFps = I.streamVideoFps + I.streamAudioFps))
                    : (I.streamFps = I.streamVideoFps),
                  I.playbackCacheLoop());
              }
            }
          }
        ...
        getFlvBufferLength() {
          let e = 0;
          return (
            f && f.buffer && (e = f.buffer.byteLength),
        ...
        fetchStream: function (e, i) {
          I.debug.log(
            ...
            (u = (function (r) {
              ...
              postMessage({ cmd: W, type: 'streamRate', value: e });
            })),
                ...
                fetch(e, { signal: h.signal })
                  .then((e) => {
                    if (se(T))
                      I.debug.log(
                        ...
                        (I.fetchStatus = Be),
                        e.body.cancel();
                    else if (e.ok && 200 <= e.status && e.status <= 299)
                      if (
                        (postMessage({ cmd: W, type: Ue }),
                        'undefined' != typeof WritableStream)
                      )
                        (I.writableStream = new WritableStream({
                          write: (e) =>
                            h && h.signal && h.signal.aborted
                              ? (I.debug.log(
                                  'worker',
                                  'writableStream write() and abortController.signal.aborted is true so return',
                                ),
                                void (I.fetchStatus = ee))
                              : se(T)
                              ? (I.debug.log(
                                  'worker',
                          ...
                          close: () => {
                            (I.fetchStatus = ee),
                              (f = null),
                              s(),
                              postMessage({ cmd: W, type: Se, value: pe });
                          },
                          abort: (e) => {
                            h && h.signal && h.signal.aborted
                              ? (I.debug.log(
                          ...
                          e.body.pipeTo(I.writableStream);
                      else {
                  ...
                  .catch((e) => {
                    h && h.signal && h.signal.aborted
                      ...
                      : e.name !== Ae &&
                        (s(),
                        postMessage({ cmd: W, type: K, value: e.toString() }),
                        (f = null));
                  }))
              : 1 === i.protocol &&
                (i.isFlv && (f = new ae(I.demuxFlv())),
                ((t = new WebSocket(e)).binaryType = 'arraybuffer'),
                (t.onopen = () => {
                  I.debug.log(
                    'worker',
                    ...
                    postMessage({ cmd: W, type: Ue }),
                    postMessage({ cmd: W, type: 'websocketOpen' });
                }),
                (t.onclose = (e) => {
                  I.debug.log(
                    'worker',
                    ...
                    se(T)
                      ...
                      : ((f = null),
                        postMessage({ cmd: W, type: Se, value: 'websocket' }));
                }),
                (t.onerror = (e) => {
                  I.debug.error(
                    'worker',
          ...
          for (;;) {
            ...
            switch (a) {
              ...
              case 9:
                  ...
                  if (r && ie(n) && null === B) {
                    ...
                    (B = 12 == r),
                      (k = (function (e, t) {
                        ...
                        return (
                          t
                            ? 28 <= e.length && (r = 1 + (3 & e[26]))
                            : 12 <= e.length && (r = 1 + (3 & e[9])),
                          r
                        );
                      })(n, B)),
                      I.debug.log(
                        'worker',
                        `demuxFlv() isVideoSequenceHeader is true and isHevc is ${B} and nalUnitSize is ` +
                          k,
                      );
                  }
                  r && I.calcIframeIntervalTimestamp(s),
                    I.isPlayer && I.calcNetworkDelay(s),
                    (i[0] = n[4]),
                    (i[1] = n[3]),
                    (i[2] = n[2]),
                    (i[3] = 0);
                      ...
                      ? (t = (function (r, i, s, e) {
                          ...
                          for (; l < o; ) {
                            ...
                            if (
                              ...
                              let e = new ht.ModeOfOperation.ctr(
                                i,
                                new ht.Counter(s),
                              );
                              const a = e.decrypt(n);
                          ...
                          return r;
                        })(n, I._opt.cryptoKey, I._opt.cryptoIV, B))
                      : I.debug.error(
                          'worker',
                          `cryptoKey.length is ${
                    ...
                    : I._opt.isSm4Crypto &&
                      (I._opt.sm4CryptoKey && r
                        ? (t = (function (e, t) {
                            ...
                            var n;
                            return e;
                          })(n, I._opt.sm4CryptoKey))
                        : I._opt.sm4CryptoKey ||
                          I.debug.error('worker', 'opt.sm4CryptoKey is null')),
                    I.decode(t, { type: 2, ts: s, isIFrame: r, cts: e });
                } else
                  I.debug.warn(
                    'worker',
                ...
                break;
              case 18:
                postMessage({ cmd: 'flvScriptData', buffer: n }, [n.buffer]);
                break;
              default:
        ...
        decode: function (e, t) {
          1 === t.type
            ? I._opt.hasAudio &&
              (postMessage({ cmd: W, type: Ee, value: e.byteLength }),
              I.isPlayer
        ...
        setCodecAudio: function (e, t) {
          const r = e[0] >> 4,
            i = (e[0] >> 1) & 1;
          if (
            ((H = r === Z.AAC ? (i ? 16 : 8) : 0 === i ? 8 : 16),
            P && P.setCodec)
          )
            if (Te(e) || r === Z.ALAW || r === Z.MULAW || r === Z.MP3) {
              I.debug.log(
                'worker',
                'setCodecAudio: init audio codec, codeId is ' + r,
              );
              const i = r === Z.AAC ? e.slice(2) : new Uint8Array(0);
          ...
          I.isDestroyed
            ...
            : ((r = e[0] >> 4),
              M
                ? r === Z.MP3
                  ? I.mp3Demuxer.dispatch(e.slice(1), t)
                  : P.decode(r === Z.AAC ? e.slice(2) : e.slice(1), t)
                : I.setCodecAudio(e, t));
        },
        ...
        decodeVideo: function (t, e, r) {
          ...
          if (I.isDestroyed)
            ...
            if ((m = !m && r ? !0 : m)) {
              if (r && ie(t)) {
                ...
                7 == n
                  ...
                  e.codecWidth &&
                    ...
                    p &&
                    c &&
                    (e.codecWidth !== p || e.codecHeight !== c) &&
                    (I.debug.warn(
                      'worker',
                      `
                            decodeVideo: video width or height is changed,
                            old width is ${p}, old height is ${c},
              ...
              I.debug.log('worker', 'decodeVideo first frame is not iFrame');
        ...
        clearBuffer: function () {
          ...
          I.debug.log(
            ...
            I.isPlayer
              ? (I.resetAllDelay(),
                se(I._opt.checkFirstIFrame) &&
                  ((I.dropping = !0), postMessage({ cmd: ve })))
              : I.isPlayback && se(I._opt.checkFirstIFrame) && (m = !1);
        },
        dropBuffer$2: function () {
          if (0 < a.length) {
            let t = a.findIndex((e) => se(e.isIFrame) && 2 === e.type);
            if (I.isAllIframeInBufferList())
              for (let e = 0; e < a.length; e++) {
                var r = a[e],
                  r = I.getDelayNotUpdateDelay(r.ts, r.type);
            ...
            0 <= t
              ? ((I.isPushDropping = !0),
                ...
                (i = (a = a.slice(t)).shift()),
                I.resetAllDelay(),
                I.getDelay(i.ts, i.type),
                I.doDecode(i),
                (I.isPushDropping = !1),
                I.debug.log(
                  'worker',
                  `dropBuffer$2() iFrameIndex is ${t},and old bufferList length is ${e} ,new bufferList is ${a.length} and new delay is ${I.delay} `,
                ))
              : (I.isPushDropping = !1);
          }
          ...
          switch (t.getUint8(0)) {
            ...
            case 2:
              if (5 < t.byteLength) {
                ...
                I.isPlayer &&
                  (I.calcNetworkDelay(r), s) &&
                  I.calcIframeIntervalTimestamp(r),
                  I.decode(i, { type: 2, ts: r, isIFrame: s });
              }
          }
        },
        ...
        findSei: function (e, r) {
          let t = 4;
          re(k) || (t = k),
            $e(e.slice(5), t).forEach((e) => {
              var t = B ? (e[0] >>> 1) & 63 : 31 & e[0];
              ((B && (t === Q.suffixSei || t === Q.prefixSei)) ||
                (ne(B) && t === J.kSliceSEI)) &&
                postMessage({ cmd: 'videoSEI', buffer: e, ts: r }, [e.buffer]);
            });
        },
        flvHasUnitTypeIDR(e, t) {
          e = $e(e.slice(5));
          let r = !1;
          return (
            e.forEach((e) => {
              e = t ? (e[0] >>> 1) & 63 : 31 & e[0];
              ((t && (e === Q.iFrame || e === Q.nLp)) ||
                (ne(t) && e === J.iFrame)) &&
                (r = !0);
            }),
            r
          ...
          m &&
            ...
            (null === g
              ...
              : e < g &&
                ...
                (g = e),
                (y = te())),
            (i = (t = e - g) < (r = te() - y) ? r - t : 0),
            (I.networkDelay = i) > I._opt.networkDelay) &&
            I._opt.playType === ce &&
            (I.debug.warn(
              'worker',
              `calcNetworkDelay now dts:${e}, start dts is ${g} vs start is ${t},local diff is ${r} ,delay is ` +
                i,
            ),
            postMessage({ cmd: W, type: 'networkDelayTimeout', value: i }));
        },
        calcIframeIntervalTimestamp: function (e) {
          null === r
            ...
            : r < e &&
              ((w = e - r),
              postMessage({ cmd: 'iframeIntervalTs', value: w }),
              (r = e));
        },
        canVisibilityDecodeNotDrop: function () {
          return I._opt.visibility && p * c <= 2073600;
        },
        ...
        videoInfo: function (e, t, r) {
          postMessage({ cmd: ye, code: e }),
            postMessage({ cmd: _e, w: t, h: r }),
            (p = t),
            (c = r),
            I.useOffscreen() &&
              ((I.offscreenCanvas = new OffscreenCanvas(t, r)),
              (I.offscreenCanvasGL = I.offscreenCanvas.getContext('webgl')),
              (I.webglObj = fe(I.offscreenCanvasGL, I._opt.openWebglAlignment)),
        ...
        yuvData: function (e, t) {
          if (I.isDestroyed)
            ...
            var r,
              ...
              i = new Uint8Array(e);
            if (((v = null), I.useOffscreen()))
              try {
                A ||
                  (I.webglObj.renderYUV(p, c, i),
                  (r = I.offscreenCanvas.transferToImageBitmap()),
                  postMessage({ cmd: j, buffer: r, delay: I.delay, ts: t }, [
                    r,
                  ]));
              } catch (e) {
                I.debug.error(
              ...
              postMessage({ cmd: j, output: i, delay: I.delay, ts: t }, [
                i.buffer,
              ]);
          }
        },
        pcmData: function (s, n, a) {
          if (I.isDestroyed)
            ...
            if (S) {
              if (!(t >= (n = i - S)))
                return (
                  ...
                  void (2 == E && (d[1] = Float32Array.of(...d[1], ...r[1])))
                );
              (b[0] = Float32Array.of(...d[0], ...r[0].subarray(0, n))),
                2 == E &&
                  (b[1] = Float32Array.of(...d[1], ...r[1].subarray(0, n))),
                postMessage(
                  { cmd: ge, buffer: b, ts: a },
                  b.map((e) => e.buffer),
                ),
                (e = n),
                (t -= n);
            ...
            for (S = t; S >= i; S -= i)
              (b[0] = r[0].slice(e, (e += i))),
                2 == E && (b[1] = r[1].slice(e - i, e)),
                postMessage(
                  { cmd: ge, buffer: b, ts: a },
                  b.map((e) => e.buffer),
                );
            S && ((d[0] = r[0].slice(e)), 2 == E) && (d[1] = r[1].slice(e));
          }
        },
