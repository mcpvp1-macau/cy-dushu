!(function (e, t) {
  ...
  var c = p(function (z) {
      ...
      var t,
        ...
        j =
          ($
            ? ((e = h ? kt.default.dirname(e) + '/' : __dirname + '/'),
              (O = () => {
                N || ((M = Tt.default), (N = kt.default));
              }),
              (t = function (e, t) {
                return (
                  O(),
      ...
      var i = {
        ...
        register: function (e, t) {
          (i.ttys[e] = { input: [], output: [], ops: t }),
            E.registerDevice(e, i.stream_ops);
        },
        stream_ops: {
          open: function (e) {
      ...
      function Be(i, t, s) {
        function r(e) {
          var t = s(e);
          t.length !== i.length && xe('Mismatched type converter count');
      ...
      function ze(e, t) {
        return (
          ...
          !!t.smartPtrType != !!t.smartPtr &&
            xe('Both smartPtrType and smartPtr must be specified'),
          (t.count = { value: 1 }),
          Re(Object.create(e, { $$: { value: t } }))
        );
      }
      function Re(e) {
        return 'undefined' == typeof FinalizationRegistry
          ...
          : ((ke = new FinalizationRegistry((e) => {
            ...
            (Te = (e) => ke.unregister(e)),
            (Re = (e) => {
              var t = e.$$;
              return t.smartPtr && ke.register(e, { $$: t }, e), e;
            })(e));
      }
      function F() {}
      function Me(e, t, r) {
      ...
      function Ge(e, t) {
        ...
        return Oe(t.$$.ptr, r, this.registeredClass);
      }
      function He(e, t) {
        if (null === t)
          return (
        ...
        if (((i = Oe(t.$$.ptr, s, this.registeredClass)), this.isSmartPointer))
          switch (
            (void 0 === t.$$.smartPtr &&
      ...
      function We(e) {
        var t = je[e];
        return (
          t || (e >= je.length && (je.length = e + 1), (je[e] = t = J.get(e))),
          t
        );
      }
      function I(e, t) {
      ...
      function tt(e) {
        4 < e && 0 == --s[e].refcount && ((s[e] = void 0), et.push(e));
      }
      var P = {
        toValue: (e) => (
          e || T('Cannot use deleted val. handle = ' + e), s[e].value
        ),
        toHandle: (e) => {
          switch (e) {
            case void 0:
            ...
            case !1:
              return 4;
            default:
              var t = et.length ? et.pop() : s.length;
              return (s[t] = { refcount: 1, value: e }), t;
          }
        },
      };
      function rt(e) {
      ...
      function pt(e, t) {
        var r = A[e];
        return void 0 === r && T(t + ' has unknown type ' + qe(e)), r;
      }
      var ct = [],
        mt = {};
      function _t() {
        if (!_t.strings) {
          ...
          for (t in mt) void 0 === mt[t] ? delete e[t] : (e[t] = mt[t]);
          var t,
            r = [];
      ...
      Object.defineProperties(gt.prototype, {
        ...
        (E.FSNode = gt),
        E.staticInit();
      for (var yt = new Array(256), bt = 0; bt < 256; ++bt)
        yt[bt] = String.fromCharCode(bt);
      (ge = yt),
        (k = _.BindingError = Ee(Error, 'BindingError')),
        (Ue = _.InternalError = Ee(Error, 'InternalError')),
        ...
        (_.getLiveInheritedInstances = function () {
          var e,
            t = [];
          for (e in Le) Le.hasOwnProperty(e) && t.push(Le[e]);
          return t;
        }),
        (_.flushPendingDeletes = Ie),
        (_.setDelayFunction = function (e) {
          (Pe = e), De.length && Pe && Pe(Ie);
        }),
        ...
        (D.prototype.readValueFromPointer = $e),
              ...
              void 0 !== (t = Le[t])
                ...
                : ((t = this.registeredClass.getActualType(i)),
                  ...
                  null ===
                    ...
                    ? s.call(this)
                    : this.isSmartPointer
                    ? ze(t.registeredClass.instancePrototype, {
                        ptrType: t,
                        ptr: r,
                        smartPtrType: this,
                        smartPtr: e,
        ...
        (Ye = _.UnboundTypeError = Ee(Error, 'UnboundTypeError')),
        (_.count_emval_handles = function () {
          for (var e = 0, t = 5; t < s.length; ++t) void 0 !== s[t] && ++e;
          return e;
        }),
        (_.get_first_emval = function () {
          for (var e = 5; e < s.length; ++e) if (void 0 !== s[e]) return s[e];
          return null;
        });
      var vt = {
          J: function (e) {
          ...
          v: function (e, t, r, i, s) {},
          G: function (e, r, i, s, n) {
            var a = _e(i);
            C(e, {
              name: (r = x(r)),
          ...
          l: function (l, e, t, d, r, h, i, u, s, f, p, n, c) {
            (p = x(p)),
              (h = I(r, h)),
              (u = u && I(i, u)),
              (f = f && I(s, f)),
            ...
            (r = m),
              (i = function () {
                Ke('Cannot construct ' + p + ' due to unbound types', [d]);
              }),
              _.hasOwnProperty(r)
              ...
              Be([l, e, t], d ? [d] : [], function (e) {
                ...
                var t,
                  ...
                  n = ((i.prototype = s), new Ne(p, i, s, c, a, h, u, f)),
                  e = new D(p, n, !0, !1, !1),
                  a = new D(p + '*', n, !1, !1, !1),
                  o = new D(p + ' const*', n, !1, !0, !1);
                return (
                  (Fe[l] = { pointerType: a, constPointerType: o }),
                  (t = m),
                  (i = i),
                  _.hasOwnProperty(t) ||
                    xe('Replacing nonexistant public symbol'),
                  _[t].overloadTable,
                  (_[t] = i),
                  (_[t].argCount = r),
                  [e, a, o]
              ...
              Be([], [e], function (t) {
                ...
                return (
                  ...
                  Be([], a, function (e) {
                    return (
                      e.splice(1, 0, null),
                      (t.registeredClass.constructor_body[i - 1] = Qe(
                        r,
                        e,
                        null,
                        s,
          ...
          g: function (e, n, a, t, r, o, l, d) {
            ...
            (n = x(n)),
              ...
              Be([], [e], function (t) {
                var r = (t = t[0]).name + '.' + n;
                function e() {
                  Ke('Cannot call ' + r + ' due to unbound types', h);
                }
                ...
                return (
                  ...
                  (void 0 === s.overloadTable &&
                    ...
                    : (Me(i, n, r), (i[n].overloadTable[a - 2] = e)),
                  Be([], h, function (e) {
                    e = Qe(r, e, t, o, l);
                    return (
          ...
          f: function (e, t, r, i) {
            (e = ft[e])((t = P.toValue(t)), (r = ut(r)), null, i);
          },
          c: tt,
          e: function (e, t) {
            var r = (function (e, t) {
                for (var r = new Array(e), i = 0; i < e; ++i)
                  r[i] = pt(p[(t + 4 * i) >> 2], 'parameter ' + i);
                return r;
              })(e, t),
              t = r[0],
              i =
            ...
            if (void 0 === s) {
              ...
              t.isVoid ||
                ...
                n.push((d += '};\n'));
              var t = Je(Function, n).apply(null, a),
                u = ft.length;
              ft.push(t), (ct[i] = s = u);
            }
            return s;
          ...
          t: function (e, t) {
            e = (e = pt(e, '_emval_take_value')).readValueFromPointer(t);
            return P.toHandle(e);
          },
          a: function () {
            c('');
        ...
        wt = (_._malloc = function () {
          return (wt = _._malloc = _.asm.O).apply(null, arguments);
        }),
        St = (_.___errno_location = function () {
          return (St = _.___errno_location = _.asm.Q).apply(null, arguments);
        }),
        Et = (_.___getTypeName = function () {
          return (Et = _.___getTypeName = _.asm.R).apply(null, arguments);
        });
      _.___embind_register_native_and_builtin_types = function () {
        return (_.___embind_register_native_and_builtin_types = _.asm.S).apply(
          null,
          arguments,
        );
      };
      var Ut,
        xt = (_._emscripten_builtin_memalign = function () {
          return (xt = _._emscripten_builtin_memalign = _.asm.T).apply(
            null,
            arguments,
          );
        }),
        Bt = (_.___cxa_is_pointer_type = function () {
          return (Bt = _.___cxa_is_pointer_type = _.asm.U).apply(
            null,
            arguments,
          );
        });
      ...
      if (
        ...
        (_._ff_h264_cabac_tables = 217004),
        (ae = function e() {
          Ut || At(), Ut || (ae = e);
        }),
        _.preInit)
                ...
                if (6 <= n.byteLength) {
                  ...
                  if (r && ie(n) && null === A) {
                    ...
                    (A = 12 == r),
                      ...
                      I.debug.log(
                        'worker',
                        `demuxFlv() isVideoSequenceHeader is true and isHevc is ${A} and nalUnitSize is ` +
                          k,
                      );
                  }
                  ...
                  I._opt.isM7sCrypto
                    ? I._opt.cryptoIV &&
                      ...
                      ? (t = (function (r, i, s, e) {
                          ...
                          return r;
                        })(n, I._opt.cryptoKey, I._opt.cryptoIV, A))
                      : I.debug.error(
                          'worker',
                          `cryptoKey.length is ${
        ...
        findSei: function (e, r) {
          ...
          re(k) || (t = k),
            $e(e.slice(5), t).forEach((e) => {
              var t = A ? (e[0] >>> 1) & 63 : 31 & e[0];
              ((A && (t === Q.suffixSei || t === Q.prefixSei)) ||
                (ne(A) && t === J.kSliceSEI)) &&
