  ...
  var c = p(function (z) {
      ...
      var yt = {
        ...
        bt = (_._malloc = function () {
          return (bt = _._malloc = _.asm.I).apply(null, arguments);
        }),
        vt = (_.___errno_location = function () {
          return (vt = _.___errno_location = _.asm.K).apply(null, arguments);
        }),
        wt = (_.___getTypeName = function () {
          return (wt = _.___getTypeName = _.asm.L).apply(null, arguments);
        });
      _.___embind_register_native_and_builtin_types = function () {
        return (_.___embind_register_native_and_builtin_types = _.asm.M).apply(
          null,
          arguments,
        );
      };
