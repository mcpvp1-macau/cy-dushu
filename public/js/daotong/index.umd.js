(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.AutelMedia = factory());
  ...
  ***************************************************************************** */
  ...
  class RTCEndpoint extends Event$1 {
    ...
    receive() {
      ...
      this.pc.createOffer().then(desc => {
        ...
        // 是否是SRS服务器
        const url = this.options.zlmsdpUrl;
        var isSRS = url.includes('whep');
        const _data = isSRS ? {
          method: 'post',
          url: url,
          data: desc.sdp,
        ...
        this.pc.setLocalDescription(desc).then(() => {
          axios(_data).then(response => {
            ...
            this.dispatch(Events$1.WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED, e);
          });
        });
      }).catch(e => {
        this.dispatch(Events$1.WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED, e);
  ...
  var PullStreamType;
  (function (PullStreamType) {
      PullStreamType["RTC"] = "rtc";
      PullStreamType["RTMP"] = "rtmp";
      PullStreamType["RTSP"] = "rtsp";
  })(PullStreamType || (PullStreamType = {}));
  var AConnectStatus;
  (function (AConnectStatus) {
      // 未连接
      AConnectStatus[AConnectStatus["DISCONNECTED"] = 0] = "DISCONNECTED";
      // 连接中
      AConnectStatus[AConnectStatus["CONNECTING"] = 1] = "CONNECTING";
      // 连接完成
      AConnectStatus[AConnectStatus["CONNECTED"] = 2] = "CONNECTED";
      // 连接失败
      AConnectStatus[AConnectStatus["FAILED"] = 3] = "FAILED";
  })(AConnectStatus || (AConnectStatus = {}));
  var ErrorCode;
  (function (ErrorCode) {
      // 接口请求拉流地址失败
      ErrorCode[ErrorCode["REQUEST_STREAMING_ADDRESS_FAILED"] = 0] = "REQUEST_STREAMING_ADDRESS_FAILED";
      //WEBRTC ICE协商失败
      ErrorCode[ErrorCode["WEBRTC_ICE_NEGOTIATION_FAILED"] = 1] = "WEBRTC_ICE_NEGOTIATION_FAILED";
      // WEBRTCoffer anwser 交换失败
      ErrorCode[ErrorCode["WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED"] = 2] = "WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED";
      // WEBRTC连接状态失败
      ErrorCode[ErrorCode["WEBRTC_ON_CONNECTION_STATE_CHANGE_FAILED"] = 3] = "WEBRTC_ON_CONNECTION_STATE_CHANGE_FAILED";
  })(ErrorCode || (ErrorCode = {}));
  var ZLMediaClient = /** @class */ (function () {
      function ZLMediaClient(el, options) {
          ...
          this.options = __assign(__assign({}, defaultsOptions), options);
          this.player = null;
          this.timer = null;
      }
      ZLMediaClient.prototype.initializePlayer = function () {
          var _this = this;
          this.getPullStreamUrl()
              .then(function (res) {
              var url = res.url;
              _this.player = new Endpoint(__assign(__assign({ element: _this.element }, _this.options), { zlmsdpUrl: url }));
              _this.registerEvents();
              _this.calculateBitrateAndLost();
          })
              .catch(function (err) {
              var _a, _b, _c, _d;
              console.error(err);
              (_b = (_a = _this.options).onerror) === null || _b === void 0 ? void 0 : _b.call(_a, ErrorCode.REQUEST_STREAMING_ADDRESS_FAILED, err);
              (_d = (_c = _this.options).onstatus) === null || _d === void 0 ? void 0 : _d.call(_c, AConnectStatus.FAILED, '请求拉流地址失败');
          });
      };
      ZLMediaClient.prototype.startPlay = function () {
          var _a, _b, _c, _d;
          (_b = (_a = this.options).onstart) === null || _b === void 0 ? void 0 : _b.call(_a);
          (_d = (_c = this.options).onstatus) === null || _d === void 0 ? void 0 : _d.call(_c, AConnectStatus.CONNECTING, '连接中');
          this.initializePlayer();
      };
      ZLMediaClient.prototype.stopPlay = function () {
          var _a, _b, _c;
          (_b = (_a = this.options).onstatus) === null || _b === void 0 ? void 0 : _b.call(_a, AConnectStatus.DISCONNECTED, '未连接');
          (_c = this.player) === null || _c === void 0 ? void 0 : _c.close();
          this.player = null;
      };
      ZLMediaClient.prototype.getPullStreamUrl = function () {
          ...
          return new Promise(function (resolve, reject) {
              axios
                  .post(getPullStreamUrlRequestUrl, {
                  stream_id: _this.options.streamId,
                  pull_type: [PullStreamType.RTC],
              }, {
                  headers: {
                      clientType: 'web',
                  },
       ...
       * 注册zlmedia回调事件
       */
      ZLMediaClient.prototype.registerEvents = function () {
          var _this = this;
          var events = [
              [Events.WEBRTC_ICE_CANDIDATE_ERROR, this.handleICECandidateError.bind(this)],
              [Events.WEBRTC_ON_REMOTE_STREAMS, this.handleRemoteStreams.bind(this)],
              [Events.WEBRTC_ON_LOCAL_STREAM, this.handleLocalStream.bind(this)],
              [Events.CAPTURE_STREAM_FAILED, this.handleCaptureStreamFailed.bind(this)],
              [Events.WEBRTC_ON_DATA_CHANNEL_OPEN, this.handleDataChannelOpen.bind(this)],
              [Events.WEBRTC_ON_DATA_CHANNEL_MSG, this.handleDataChannelMessage.bind(this)],
              [Events.WEBRTC_ON_DATA_CHANNEL_ERR, this.handleDataChannelError.bind(this)],
              [Events.WEBRTC_ON_DATA_CHANNEL_CLOSE, this.handleDataChannelClose.bind(this)],
              [Events.WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED, this.handleOfferAnswerExchangeFailed.bind(this)],
              [Events.WEBRTC_ON_CONNECTION_STATE_CHANGE, this.handleConnectionStateChange.bind(this)],
          ];
          events.forEach(function (_a) {
              var _b;
              var event = _a[0], handler = _a[1];
              return (_b = _this.player) === null || _b === void 0 ? void 0 : _b.on(event, handler);
          });
      };
      /**
       * 计算比特率
       */
      ZLMediaClient.prototype.calculateBitrateAndLost = function () {
          var _this = this;
          var _a, _b;
          // 重置比特率值
          ...
          // 上一次丢失的包
          var lastLost = 0;
          if (!((_a = this.player) === null || _a === void 0 ? void 0 : _a.pc))
              return;
          // 连接对象
          var pc = (_b = this.player) === null || _b === void 0 ? void 0 : _b.pc;
          this.timer = setInterval(function () { return __awaiter(_this, void 0, void 0, function () {
              var selector, report, err_1;
              var _this = this;
              var _a;
              return __generator(this, function (_b) {
                  switch (_b.label) {
                      case 0:
                          selector = (_a = pc.getRemoteStreams()[0]) === null || _a === void 0 ? void 0 : _a.getVideoTracks()[0];
                          _b.label = 1;
                      case 1:
                          _b.trys.push([1, 3, , 4]);
                          return [4 /*yield*/, pc.getStats(selector)];
                      case 2:
                          report = _b.sent();
                          report.forEach(function (stats) {
                              ...
                              if (stats.type === 'inbound-rtp') {
                                  ...
                                  // 计算两个时间点之间的接收字节数和时间差
                                  var deltaBytes = receivedBytes - lastReceivedBytes;
                                  var deltaTime = timestamp - lastTimestamp;
                                  // 更新比特率值
                                  var bitrate = (((deltaBytes / deltaTime) * 8) / 1000).toFixed(2);
                                  // 更新存储的接收字节数和时间戳值以备下次计算使用
                                  lastReceivedBytes = receivedBytes;
                                  lastTimestamp = timestamp;
                                  // 计算丢包率
                                  var lost = stats.packetsLost;
                                  stats.packetsReceived;
                                  var lostrate = lost - lastLost;
                                  lastLost = lost;
                                  // 视频分辨率比例
                                  var videoRatio = stats.frameWidth / stats.frameHeight;
                                  // 触发比特率、丢包率更新回调
                                  (_b = (_a = _this.options).oninfo) === null || _b === void 0 ? void 0 : _b.call(_a, {
                                      bitrate: bitrate,
                                      lostrate: lostrate + '',
                                      videoRatio: videoRatio,
                                      keyFrames: stats.keyFramesDecoded,
                                  });
                              }
                          });
                          return [3 /*break*/, 4];
                      case 3:
                          err_1 = _b.sent();
                          console.warn('获取视频流通信信息失败：', err_1);
                          return [3 /*break*/, 4];
      ...
      // 以下是事件处理函数，注意使用普通函数而不是箭头函数
      ZLMediaClient.prototype.handleICECandidateError = function (e) {
          var _a, _b, _c, _d;
          console.log('ICE 协商出错');
          (_b = (_a = this.options).onstatus) === null || _b === void 0 ? void 0 : _b.call(_a, AConnectStatus.FAILED, '连接失败，ICE 协商出错');
          if (!this.player)
              return;
          (_d = (_c = this.options).onerror) === null || _d === void 0 ? void 0 : _d.call(_c, ErrorCode.WEBRTC_ICE_NEGOTIATION_FAILED, e);
      };
      ZLMediaClient.prototype.handleRemoteStreams = function (event) {
          var _a, _b;
          console.log('播放成功', event.streams);
          (_b = (_a = this.options).onsuccess) === null || _b === void 0 ? void 0 : _b.call(_a);
      };
      ZLMediaClient.prototype.handleOfferAnswerExchangeFailed = function (event) {
          var _a, _b, _c, _d;
          console.log('offer anwser 交换失败');
          (_b = (_a = this.options).onstatus) === null || _b === void 0 ? void 0 : _b.call(_a, AConnectStatus.FAILED, '连接失败,offer anwser 交换失败');
          if (!this.player)
              return;
          (_d = (_c = this.options).onerror) === null || _d === void 0 ? void 0 : _d.call(_c, ErrorCode.WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED, event);
      };
      ZLMediaClient.prototype.handleLocalStream = function (stream) {
          console.log('获取到了本地流', stream);
      };
      ZLMediaClient.prototype.handleCaptureStreamFailed = function () {
          console.log('获取本地流失败');
      };
      ZLMediaClient.prototype.handleConnectionStateChange = function (state) {
          var _a, _b, _c, _d, _e, _f;
          console.log('当前状态==>', state);
          if (state === 'disconnected' || state === 'failed') {
              (_b = (_a = this.options).onstatus) === null || _b === void 0 ? void 0 : _b.call(_a, AConnectStatus.FAILED, '连接失败');
              if (!this.player)
                  return;
              (_d = (_c = this.options).onerror) === null || _d === void 0 ? void 0 : _d.call(_c, ErrorCode.WEBRTC_ON_CONNECTION_STATE_CHANGE_FAILED, state);
          }
          if (state === 'connected') {
              (_f = (_e = this.options).onstatus) === null || _f === void 0 ? void 0 : _f.call(_e, AConnectStatus.CONNECTED, '连接成功');
          }
      };
      ZLMediaClient.prototype.handleDataChannelOpen = function (event) {
          console.log('rtc datachannel 打开 :', event);
      };
      ZLMediaClient.prototype.handleDataChannelMessage = function (event) {
          console.log('rtc datachannel 消息 :', event === null || event === void 0 ? void 0 : event.data);
      };
      ZLMediaClient.prototype.handleDataChannelError = function (event) {
