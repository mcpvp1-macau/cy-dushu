;(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  class RTCEndpoint extends Event$1 {
    ...
    switchVideo(useCamera, deviceId) {
      ...
      return MediaStreamFactory.createMediaStream(
        ...
        return es6Promise.Promise.reject(
          'video not exist or deviceid not vaild',
        )
      })
    }
    switcAudio(useMic, deviceId) {
      ...
      return MediaStreamFactory.createMediaStream(
        ...
        return es6Promise.Promise.reject(
          'audio not exist or deviceid not vaild',
        )
      })
    }
    closeDataChannel() {
  ...
  ;(function (ErrorCode) {
    // 接口请求拉流地址失败
    ErrorCode[(ErrorCode['REQUEST_STREAMING_ADDRESS_FAILED'] = 0)] =
      'REQUEST_STREAMING_ADDRESS_FAILED'
    //WEBRTC ICE协商失败
    ErrorCode[(ErrorCode['WEBRTC_ICE_NEGOTIATION_FAILED'] = 1)] =
      'WEBRTC_ICE_NEGOTIATION_FAILED'
    // WEBRTCoffer anwser 交换失败
    ErrorCode[(ErrorCode['WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED'] = 2)] =
      'WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED'
    // WEBRTC连接状态失败
    ErrorCode[(ErrorCode['WEBRTC_ON_CONNECTION_STATE_CHANGE_FAILED'] = 3)] =
      'WEBRTC_ON_CONNECTION_STATE_CHANGE_FAILED'
  })(ErrorCode || (ErrorCode = {}))
  var ZLMediaClient = /** @class */ (function () {
    ...
    ZLMediaClient.prototype.initializePlayer = function () {
      ...
      this.getPullStreamUrl()
        .then(function (res) {
          var url = res.url
          _this.player = new Endpoint(
            __assign(__assign({ element: _this.element }, _this.options), {
              zlmsdpUrl: url,
            }),
          )
        ...
        .catch(function (err) {
          var _a, _b, _c, _d
          console.error(err)
          ;(_b = (_a = _this.options).onerror) === null || _b === void 0
            ? void 0
            : _b.call(_a, ErrorCode.REQUEST_STREAMING_ADDRESS_FAILED, err)
          ;(_d = (_c = _this.options).onstatus) === null || _d === void 0
            ? void 0
            : _d.call(_c, AConnectStatus.FAILED, '请求拉流地址失败')
        })
    }
    ZLMediaClient.prototype.startPlay = function () {
      var _a, _b, _c, _d
      ;(_b = (_a = this.options).onstart) === null || _b === void 0
        ? void 0
        : _b.call(_a)
      ;(_d = (_c = this.options).onstatus) === null || _d === void 0
        ? void 0
        : _d.call(_c, AConnectStatus.CONNECTING, '连接中')
      this.initializePlayer()
    }
    ZLMediaClient.prototype.stopPlay = function () {
      var _a, _b, _c
      ;(_b = (_a = this.options).onstatus) === null || _b === void 0
        ? void 0
        : _b.call(_a, AConnectStatus.DISCONNECTED, '未连接')
    ...
    ZLMediaClient.prototype.getPullStreamUrl = function () {
      ...
      var _a = this.options,
        _b = _a.serverUrl,
        serverUrl = _b === void 0 ? '' : _b,
        proxyPrefix = _a.proxyPrefix
      var getPullStreamUrlRequestUrl =
        serverUrl + '/api/v1/stream/getPullStreamUrl'
      return new Promise(function (resolve, reject) {
        axios
          .post(
            getPullStreamUrlRequestUrl,
            {
          ...
          .then(function (res) {
            ...
            if (data) {
              ...
              if (window.config && window.config.daotongIntranet) {
                external_1 = data.intranet
              }
              var pull = (external_1 || {}).pull
              var url =
                ((_a = pull[0]) === null || _a === void 0 ? void 0 : _a.url) ||
                ''
              resolve({
                url: proxyPrefix
                  ? ' '
                      .concat(proxyPrefix)
                      .concat(proxyPrefix.endsWith('/') ? '' : '/')
                      .concat(url)
                  : url,
              })
            } else {
    ...
    ZLMediaClient.prototype.registerEvents = function () {
      ...
      var events = [
        ...
        [
          ...
          this.handleCaptureStreamFailed.bind(this),
        ],
        [
        ...
        [
          ...
          this.handleDataChannelError.bind(this),
        ],
        [
          Events.WEBRTC_ON_DATA_CHANNEL_CLOSE,
          this.handleDataChannelClose.bind(this),
        ],
        [
          Events.WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED,
          this.handleOfferAnswerExchangeFailed.bind(this),
        ],
        [
      ...
      events.forEach(function (_a) {
        ...
        var event = _a[0],
          handler = _a[1]
        return (_b = _this.player) === null || _b === void 0
          ? void 0
          : _b.on(event, handler)
      })
    }
        ...
        return __awaiter(_this, void 0, void 0, function () {
          ...
          return __generator(this, function (_b) {
            switch (_b.label) {
              case 0:
                selector =
                  (_a = pc.getRemoteStreams()[0]) === null || _a === void 0
                    ? void 0
                    : _a.getVideoTracks()[0]
                _b.label = 1
              case 1:
              ...
              case 2:
                ...
                report.forEach(function (stats) {
                  ...
                  if (stats.type === 'inbound-rtp') {
                    ...
                    // 触发比特率、丢包率更新回调
                    ;(_b = (_a = _this.options).oninfo) === null ||
                    _b === void 0
                      ? void 0
                      : _b.call(_a, {
                          bitrate: bitrate,
    ...
    ZLMediaClient.prototype.handleICECandidateError = function (e) {
      ...
      ;(_b = (_a = this.options).onstatus) === null || _b === void 0
        ? void 0
        : _b.call(_a, AConnectStatus.FAILED, '连接失败，ICE 协商出错')
      if (!this.player) return
      ;(_d = (_c = this.options).onerror) === null || _d === void 0
        ? void 0
        : _d.call(_c, ErrorCode.WEBRTC_ICE_NEGOTIATION_FAILED, e)
    }
    ...
    ZLMediaClient.prototype.handleOfferAnswerExchangeFailed = function (event) {
      ...
      ;(_b = (_a = this.options).onstatus) === null || _b === void 0
        ? void 0
        : _b.call(_a, AConnectStatus.FAILED, '连接失败,offer anwser 交换失败')
      if (!this.player) return
      ;(_d = (_c = this.options).onerror) === null || _d === void 0
        ? void 0
        : _d.call(_c, ErrorCode.WEBRTC_OFFER_ANWSER_EXCHANGE_FAILED, event)
    }
    ...
    ZLMediaClient.prototype.handleConnectionStateChange = function (state) {
      ...
      if (state === 'disconnected' || state === 'failed') {
        ;(_b = (_a = this.options).onstatus) === null || _b === void 0
          ? void 0
          : _b.call(_a, AConnectStatus.FAILED, '连接失败')
        if (!this.player) return
        ;(_d = (_c = this.options).onerror) === null || _d === void 0
          ? void 0
          : _d.call(
              _c,
              ErrorCode.WEBRTC_ON_CONNECTION_STATE_CHANGE_FAILED,
              state,
            )
      }
      if (state === 'connected') {
        ;(_f = (_e = this.options).onstatus) === null || _f === void 0
          ? void 0
          : _f.call(_e, AConnectStatus.CONNECTED, '连接成功')
      }
    }
