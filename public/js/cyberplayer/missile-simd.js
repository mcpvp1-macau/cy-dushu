...
var wasmBinaryFile;
wasmBinaryFile = 'missile-simd.wasm';
...
function ___handle_stack_overflow(requested) {
  ...
  abort(
    'stack overflow (Attempt to set SP to ' +
      ptrToString(requested) +
      ', with stack limits [' +
      ptrToString(end) +
      ' - ' +
      ptrToString(base) +
...
var _registerPlayer = (Module['_registerPlayer'] =
  createExportWrapper('registerPlayer'));
var _setCodecType = (Module['_setCodecType'] =
  createExportWrapper('setCodecType'));
var _exitMissile = (Module['_exitMissile'] =
  createExportWrapper('exitMissile'));
var _initializeDecoder = (Module['_initializeDecoder'] =
  createExportWrapper('initializeDecoder'));
var _decodeCodecContext = (Module['_decodeCodecContext'] =
  createExportWrapper('decodeCodecContext'));
var _closeVideo = (Module['_closeVideo'] = createExportWrapper('closeVideo'));
var _release = (Module['_release'] = createExportWrapper('release'));
var _AVPlayerInit = (Module['_AVPlayerInit'] =
  createExportWrapper('AVPlayerInit'));
var _initTsMissile = (Module['_initTsMissile'] =
  createExportWrapper('initTsMissile'));
var _exitTsMissile = (Module['_exitTsMissile'] =
  createExportWrapper('exitTsMissile'));
var _free = (Module['_free'] = createExportWrapper('free'));
var _initializeDemuxer = (Module['_initializeDemuxer'] =
  createExportWrapper('initializeDemuxer'));
var _demuxBox = (Module['_demuxBox'] = createExportWrapper('demuxBox'));
var _getMediaInfo = (Module['_getMediaInfo'] =
  createExportWrapper('getMediaInfo'));
var _getExtensionInfo = (Module['_getExtensionInfo'] =
  createExportWrapper('getExtensionInfo'));
var _getVideoCodecID = (Module['_getVideoCodecID'] =
  createExportWrapper('getVideoCodecID'));
var _getAudioCodecID = (Module['_getAudioCodecID'] =
  createExportWrapper('getAudioCodecID'));
var _getPacket = (Module['_getPacket'] = createExportWrapper('getPacket'));
var _getVLCLen = (Module['_getVLCLen'] = createExportWrapper('getVLCLen'));
var _getVLC = (Module['_getVLC'] = createExportWrapper('getVLC'));
var _getVPSLen = (Module['_getVPSLen'] = createExportWrapper('getVPSLen'));
var _getVPS = (Module['_getVPS'] = createExportWrapper('getVPS'));
var _getSPSLen = (Module['_getSPSLen'] = createExportWrapper('getSPSLen'));
var _getSPS = (Module['_getSPS'] = createExportWrapper('getSPS'));
var _getPPSLen = (Module['_getPPSLen'] = createExportWrapper('getPPSLen'));
var _getPPS = (Module['_getPPS'] = createExportWrapper('getPPS'));
var _getSEILen = (Module['_getSEILen'] = createExportWrapper('getSEILen'));
var _getSEI = (Module['_getSEI'] = createExportWrapper('getSEI'));
var _AVSniffStreamInit = (Module['_AVSniffStreamInit'] =
  createExportWrapper('AVSniffStreamInit'));
var _releaseSniffStream = (Module['_releaseSniffStream'] =
  createExportWrapper('releaseSniffStream'));
var _initializeSniffStreamModule = (Module['_initializeSniffStreamModule'] =
  createExportWrapper('initializeSniffStreamModule'));
var _initializeSniffStreamModuleWithAOpt = (Module[
  '_initializeSniffStreamModuleWithAOpt'
] = createExportWrapper('initializeSniffStreamModuleWithAOpt'));
var _pushSniffStreamData = (Module['_pushSniffStreamData'] =
  createExportWrapper('pushSniffStreamData'));
var _getSniffStreamPkg = (Module['_getSniffStreamPkg'] =
  createExportWrapper('getSniffStreamPkg'));
var _getSniffStreamPkgNoCheckProbe = (Module['_getSniffStreamPkgNoCheckProbe'] =
  createExportWrapper('getSniffStreamPkgNoCheckProbe'));
var _decodeVideoFrame = (Module['_decodeVideoFrame'] =
  createExportWrapper('decodeVideoFrame'));
var _naluLListLength = (Module['_naluLListLength'] =
  createExportWrapper('naluLListLength'));
var _AVSniffHttpFlvInit = (Module['_AVSniffHttpFlvInit'] =
  createExportWrapper('AVSniffHttpFlvInit'));
var _releaseSniffHttpFlv = (Module['_releaseSniffHttpFlv'] =
  createExportWrapper('releaseSniffHttpFlv'));
var _initializeSniffHttpFlvModule = (Module['_initializeSniffHttpFlvModule'] =
  createExportWrapper('initializeSniffHttpFlvModule'));
var _initializeSniffHttpFlvModuleWithAOpt = (Module[
  '_initializeSniffHttpFlvModuleWithAOpt'
] = createExportWrapper('initializeSniffHttpFlvModuleWithAOpt'));
var _pushSniffHttpFlvData = (Module['_pushSniffHttpFlvData'] =
  createExportWrapper('pushSniffHttpFlvData'));
var _getBufferLengthApi = (Module['_getBufferLengthApi'] =
  createExportWrapper('getBufferLengthApi'));
var _getSniffHttpFlvPkg = (Module['_getSniffHttpFlvPkg'] =
  createExportWrapper('getSniffHttpFlvPkg'));
var _getSniffHttpFlvPkgNoCheckProbe = (Module[
  '_getSniffHttpFlvPkgNoCheckProbe'
] = createExportWrapper('getSniffHttpFlvPkgNoCheckProbe'));
var _decodeHttpFlvVideoFrame = (Module['_decodeHttpFlvVideoFrame'] =
  createExportWrapper('decodeHttpFlvVideoFrame'));
var _releaseHttpFLV = (Module['_releaseHttpFLV'] =
  createExportWrapper('releaseHttpFLV'));
...
var _ff_h264_cabac_tables = (Module['_ff_h264_cabac_tables'] = 180024);
Module['ccall'] = ccall;
Module['cwrap'] = cwrap;
