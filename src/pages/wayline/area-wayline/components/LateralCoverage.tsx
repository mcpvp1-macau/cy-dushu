...
/** 覆盖率 */
const LateralCoverage: FC<PropsType> = memo(() => {
    ...
    <XCard
      title={
        <div className="flex items-center gap-1">
          {t('wayline.waylineConfig.lateralCoverage.title')}
          <Tooltip
            className="ml-1"
            title={
...
LateralCoverage.displayName = 'LateralCoverage'

export default LateralCoverage
