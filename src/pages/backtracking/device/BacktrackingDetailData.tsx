...
const BacktrackingDetailData: FC<PropsType> = memo(({ deviceId, deviceDetail }) => {
...
BacktrackingDetailData.displayName = 'BacktrackingDetailData'

export default BacktrackingDetailData
