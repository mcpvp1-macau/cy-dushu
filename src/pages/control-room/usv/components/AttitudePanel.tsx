...
const AttitudePanel: FC = memo(() => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center">
      <div className="relative h-32 w-32 pointer-events-none">
        ...
        <Tooltip
          ...
          title={t('usv.attitude.heading', '艏向')}
        >
          <div
        ...
        <Tooltip className="pointer-events-auto" title={t('usv.attitude.pitch', '纵摇')}>
          <div
        ...
        <Tooltip className="pointer-events-auto" title={t('usv.attitude.roll', '横摇')}>
          <div
