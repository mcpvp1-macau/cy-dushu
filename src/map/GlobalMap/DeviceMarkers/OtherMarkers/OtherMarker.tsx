import useGlobalWsStore, {
  ...
  import uav from '@/assets/marker/icon/uav.svg'
  ...
  import camera from '@/assets/marker/jiankong.png'
  import zhifayi from '@/assets/marker/zhifayi.png'
  import ren from '@/assets/marker/ren.png'
  import wanglou from '@/assets/marker/wanglou.png'
  import car from '@/assets/marker/icon/car.svg'
