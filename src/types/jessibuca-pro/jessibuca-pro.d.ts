...
declare class JessibucaPro {
  ...
  /**
     ...
     */
  on(
    event: JessibucaPro.EVENTS.error,
    callback: (err: JessibucaPro.ERROR) => void,
  ): void
  ...
  on(
    ...
    callback: (performance: 0 | 1 | 2) => void,
  ): void
  ...
  /**
     ...
     */
  on(
    event: JessibucaPro.EVENTS.recordingTimestamp,
   ...
   */
  on(
    event: JessibucaPro.EVENTS.streamQualityChange,
   ...
   */
  on(
    event: JessibucaPro.EVENTS.zooming,
    callback: (flag: boolean) => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.EVENTS.visibilityHiddenTimeout,
    callback: () => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.EVENTS.audioResumeState,
    callback: (options: {
   ...
   */
  on(
    event: JessibucaPro.ERROR.decoderWorkerInitError,
   ...
   */
  on(
    event: JessibucaPro.ERROR.videoElementPlayingFailed,
    callback: (error: string) => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.ERROR.videoElementPlayingFailedForWebrtc,
    callback: (error: string) => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.EVENTS.flvMetaData,
   ...
   */
  on(
    event: JessibucaPro.EVENTS.videoSEI,
    callback: (data: { ts: string; data: Uint8Array }) => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.EVENTS.webrtcOnConnectionStateChange,
    callback: (data: object) => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.EVENTS.webrtcOnIceConnectionStateChange,
    callback: (data: object) => void,
  ): void
   ...
   */
  on(
    event: JessibucaPro.EVENTS.aiObjectDetectorInfo,
    callback: (data: object) => void,
  ): void
