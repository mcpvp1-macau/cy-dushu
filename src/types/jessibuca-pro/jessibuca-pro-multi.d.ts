import JessibucaProN from './jessibuca-pro'
...
declare class JessibucaProMulti {
   ...
   * 获取视频信息
   */
  getVideoInfo(windowIndex?: number): {
    width: number
    height: number
    encType: string
  }
   ...
   * 获取音频信息
   */
  getAudioInfo(windowIndex?: number): {
    sampleRate: number
    channels: number
    encType: string
  }
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.selected,
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.mouseOut,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.mouseOver,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.mouseUp,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.dragenter,
    callback: (windowIndex: number, event: any) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.dragleave,
    callback: (windowIndex: number, event: any) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.MULTI_EVENTS.drop,
    callback: (windowIndex: number, event: any) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.load,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.timeUpdate,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.ERROR.fetchError,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.ERROR.websocketError,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.start,
    callback: (windowIndex: number) => void,
  ): void
  ...
  on(
    ...
    callback: (
      windowIndex: number,
      error: JessibucaProMulti.EVENTS.timeout,
    ) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.loadingTimeout,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.delayTimeout,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.fullscreen,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.play,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.pause,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.mute,
    callback: (windowIndex: number) => void,
  ): void
  ...
  /**
     ...
     */
  on(
    event: JessibucaProMulti.EVENTS.recordStart,
    callback: (windowIndex: number) => void,
  ): void
  ...
  /**
     ...
     */
  on(
    event: JessibucaProMulti.EVENTS.recordEnd,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.streamQualityChange,
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.close,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.focus,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.blur,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.websocketOpen,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.websocketClose,
    callback: (windowIndex: number) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.audioResumeState,
    callback: (
      windowIndex: number,
      options: {
   ...
   */
  on(
    event: JessibucaProMulti.ERROR.decoderWorkerInitError,
    callback: (windowIndex: number, error: string) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.ERROR.videoElementPlayingFailed,
    callback: (windowIndex: number, error: string) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.ERROR.videoElementPlayingFailedForWebrtc,
    callback: (windowIndex: number, error: string) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.flvMetaData,
    callback: (windowIndex: number, data: object) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.videoSEI,
    callback: (
      windowIndex: number,
      data: {
        ts: string
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.webrtcOnConnectionStateChange,
    callback: (windowIndex: number, data: object) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.webrtcOnIceConnectionStateChange,
    callback: (windowIndex: number, data: object) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.aiObjectDetectorInfo,
    callback: (windowIndex: number, data: object) => void,
  ): void
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.networkDelayTimeout,
    callback: (windowIndex: number) => void,
  ): void
  /**
     * 监听方法
